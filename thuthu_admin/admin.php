...
// Xử lý tìm kiếm và lọc theo thể loại
...
if ($search_query) {
    ...
    $where_clauses[] = "(TenSach LIKE '%$search_query%' OR TenTacGia LIKE '%$search_query%' OR TheLoai LIKE '%$search_query%')";
}

if ($category_filter) {
    $category_filter = $conn->real_escape_string($category_filter);
    $where_clauses[] = "TheLoai = '$category_filter'";
}
...
if ($category) {
    $sql = "SELECT TheLoai FROM sach = '$category'";
}
    ...
    <div class="main-content">
        <header>
            <div class="header-content">
                <div class="logo"><a href="admin.php" style="color:white; text-decoration:none;">QUẢN LÝ SÁCH THƯ VIỆN</a></div>
        ...
        <nav class="category-menu">
                <ul>
                <li><a href="admin.php">TẤT CẢ SÁCH</a>
                    <ul class="dropdown">
                        <li><a href="admin.php?category=congnghe">CÔNG NGHỆ</a></li>
                        <li><a href="admin.php?category=khoahoc">KHOA HỌC</a></li>
                        <li><a href="admin.php?category=vientuong">VIỄN TƯỞNG</a></li>
                        <li><a href="admin.php?category=tho">THƠ</a></li>
                        <li><a href="admin.php?category=thieunhi">THIẾU NHI</a></li>
                        <li><a href="admin.php?category=vanhoc">VĂN HỌC</a></li>
                        <li><a href="admin.php?category=kynang">KỸ NĂNG</a></li>
                        <li><a href="admin.php?category=kinhdoanh">KINH DOANH</a></li>
                        <li><a href="admin.php?category=hoiky">HỒI KÝ</a></li>
                        <li><a href="admin.php?category=lich-su">LỊCH SỬ</a></li>
                        <li><a href="admin.php?category=truyentranh">TRUYỆN TRANH</a></li>
                    </ul>
                </li>
                <li><a href="admin.php?category=congnghe">CÔNG NGHỆ</a></li>
                <li><a href="admin.php?category=vanhoc">VĂN HỌC</a></li>
